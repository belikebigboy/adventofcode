...
public class Day1 {
    ...
    private static int countChars(String inputString, String search) {
        int count = inputString.length() - inputString.replace(search ,"").length();
        System.out.println("Counted " + count+" " + search + " chars in input string");
        return count;
    }
