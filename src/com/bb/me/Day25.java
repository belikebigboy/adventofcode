...
public class Day25 {
    ...
    private static long populateMap(int initial, int x, int y) {
    ...
    public static void main(String[] args) {
        ...
        long result = populateMap(20151125, 2947, 3029);
        time = System.currentTimeMillis() - time;

        System.out.println("Code for row 2947-3029 " + result);

        System.out.println(time);

        //System.out.println("Code for row 2947-3029" + getCode(20151125, 2947, 3029));
